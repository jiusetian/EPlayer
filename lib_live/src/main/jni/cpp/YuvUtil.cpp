...
// nv21 --> i420
void YuvUtil::nv21ToI420(jbyte *src_nv21_data, jint width, jint height, jbyte *src_i420_data) {
...
// i420 --> nv21
void YuvUtil::i420ToNv21(jbyte *src_i420_data, jint width, jint height, jbyte *src_nv21_data) {
    jint src_y_size = width * height;
    jint src_u_size = (width >> 1) * (height >> 1);
...
// nv12 --> i420
void YuvUtil::nv12ToI420(jbyte *Src_data, jint src_width, jint src_height, jbyte *Dst_data) {
    // NV12 video size
...
// i420 --> nv12
void YuvUtil::i420ToNv12(jbyte *src_i420_data, jint width, jint height, jbyte *src_nv12_data) {
    jint src_y_size = width * height;
    jint src_u_size = (width >> 1) * (height >> 1);
...
// 镜像
void YuvUtil::mirrorI420(jbyte *src_i420_data, jint width, jint height, jbyte *dst_i420_data) {
...
// 旋转
void YuvUtil::rotateI420(jbyte *src_i420_data, jint width, jint height, jbyte *dst_i420_data, jint degree) {
    jint src_i420_y_size = width * height;
    jint src_i420_u_size = (width >> 1) * (height >> 1);
...
// 缩放
void YuvUtil::scaleI420(jbyte *src_i420_data, jint width, jint height, jbyte *dst_i420_data, jint dst_width,
...
// 裁剪
void YuvUtil::cropI420(jbyte *src_i420_data, jint src_length, jint width, jint height,
