...
//        System.loadLibrary("avdevice");
    ...
    @AccessedByNative
    private long mNativeContext; //对应native层的EMediaPlayer对象
    @AccessedByNative
    ...
    public EasyMediaPlayer() {
         ...
         */
        native_setup(new WeakReference<EasyMediaPlayer>(this));
    }
    ...
    public static EasyMediaPlayer create(Context context, Uri uri, SurfaceHolder holder) {
        ...
        try {
            EasyMediaPlayer mp = new EasyMediaPlayer();
    ...
    private class EventHandler extends Handler {
        ...
        public EventHandler(EasyMediaPlayer mp, Looper looper) {
            super(looper);
            mMediaPlayer = mp;
        }
                    ...
                    if (mOnTimedTextListener != null) {
                        if (msg.obj == null) {
                            ...
                            if (msg.obj instanceof byte[]) {
                                ETimedText text = new ETimedText(new Rect(0, 0, 1, 1), (String) (msg.obj));
